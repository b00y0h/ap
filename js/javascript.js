/* homepage slideshow funtion */
function homeSlideshow() {
	myShow = new Slideshow('slideshow', { type: 'fade', duration: [2000, 4000], width: 648, height: 180, images: ['1.jpg','2.jpg','3.jpg','4.jpg'], hu: 'assets/' });
}
...
window.addEvent('domready', function(){
	...
	var Tips2 = new Tips($$('.information a'), {
		initialize:function(){
